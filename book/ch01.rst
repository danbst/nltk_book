...
якщо ми тільки можемо писати певні простенькі програми? В даному розділі ми обговоримо наступні питання:
...
інтерфейс |IDLE|. Під Mac ви знайдете його у *Applications*\ |rarr|\ *MacPython*, а під Windows у *All Programs*\ |rarr|\ *Python*. Під Unix ви можете просто 
...
Коли ви завантажили |NLTK|, запустіть інтерпретатор Пайтона як і раніше і встановіть дані, потрібні для книги просто ввівши наступні дві команди у полі вводу Пайтона, а потім вибравши колекцію ``book``, як показано на fig-nltk-downloader_.
